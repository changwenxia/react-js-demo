    ...
    return (
        ...
        >
            <div className='colors-con'>
                {
                    globalConfig.customColorPrimarys && globalConfig.customColorPrimarys.map((item, index) => {
                        return (
                            <div className='theme-color' style={{backgroundColor: item}} key={index} onClick={()=>dispatch(setColorPrimary(item))}>
                                {
